<div class="container" style="text-align: center; margin-bottom: 40px;">
      <h1 class="text-secondary" style="font-size: 3vw;" >Acerca de Nosotros</h1>
        ...
        <p class="text-secondary" style="text-align: justify;">
          SARAM es desarrollado por un equipo de jovenes estudiantes que cursan el 8vo semestre de la carrera de Ingeniería en Sistemas Computacionales del Tecnológico de Estudios Superiores de Chalco. 
        </p>
          <!-- Three columns of text below the carousel -->
        <div class="row">
          <div class="col-lg-3 bg-secondary rounded" style="padding: 10px;">
